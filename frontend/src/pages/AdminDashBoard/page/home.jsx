  ...
  <section id="dashboardReectangle3">
    ...
    <Typography variant="h6" noWrap component="div" style={{position: "absolute",left:"28px",top:"25px"}}>
          ...
          <TextField id="outlined-basic" label="Brand" variant="outlined" style={{position: "relative",top:"-70px",backgroundColor:"white",color:"white",left:"20px",zIndex:"1",width:"35%"}}/>
              <TextField id="outlined-basic" label="Daily Rate" variant="outlined" style={{position: "relative",top:"-70px",backgroundColor:"white",color:"white",left:"25px",zIndex:"1",width:"35%"}}/>
              <TextField id="outlined-basic" label="Free KM Day" variant="outlined" style={{position: "relative",top:"-70px",backgroundColor:"white",color:"white",left:"20px",zIndex:"1",width:"35%"}}/>
              <TextField id="outlined-basic" label="Free KM Month" variant="outlined" style={{position: "relative",top:"-70px",backgroundColor:"white",color:"white",left:"25px",zIndex:"1",width:"35%"}}/><br/>
              <TextField id="outlined-basic" label="Monthly Rate" variant="outlined" style={{position: "relative",top:"-70px",backgroundColor:"white",color:"white",left:"20px",zIndex:"1",width:"35%"}}/>
              <TextField id="outlined-basic" label="Price Per Extra KM" variant="outlined" style={{position: "relative",top:"-70px",backgroundColor:"white",color:"white",left:"25px",zIndex:"1",width:"35%"}}/>  
    ...
    <Typography variant="h6" noWrap component="div" style={{position: "absolute",left:"28px",top:"25px",zIndex:"2"}}>
           Add Driver Details
            ...
            <div id="driverBtn">
              ...
              <TextField id="outlined-basic" label="Driver NIC" variant="outlined" style={{position: "relative",top:"-25px",margin:"5px",backgroundColor:"white",color:"white",left:"13px",zIndex:"1",width:"35%"}}/>
              <TextField id="outlined-basic" label="License No" variant="outlined" style={{position: "relative",top:"-25px",margin:"5px",backgroundColor:"white",color:"white",left:"25px",zIndex:"1",width:"35%"}}/>
              <TextField id="outlined-basic" label="Name" variant="outlined" style={{position: "relative",top:"-25px",margin:"5px",backgroundColor:"white",color:"white",left:"13px",zIndex:"1",width:"35%"}}/>
              <TextField id="outlined-basic" label="Address" variant="outlined" style={{position: "relative",top:"-25px",margin:"5px",backgroundColor:"white",color:"white",left:"25px",zIndex:"1",width:"35%"}}/><br/>
              <TextField id="outlined-basic" label="Contact No" variant="outlined" style={{position: "relative",top:"-25px",margin:"5px",backgroundColor:"white",color:"white",left:"13px",zIndex:"1",width:"35%"}}/>
              <TextField id="outlined-basic" label="Salary" variant="outlined" style={{position: "relative",top:"-25px",margin:"5px",backgroundColor:"white",color:"white",left:"25px",zIndex:"1",width:"35%"}}/>  
